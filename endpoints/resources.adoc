...
[.lead]
You can use the resources provided through the Astra Control REST API to automate an Astra deployment. Each resource is access through one or more endpoints. The information presented below provides an introduction to the REST resources you can use as part of an automation deployment.
...
The following REST endpoints have been added with the current 22.04 Astra Control release. In addition, the versions of several existing resources have been upgraded.
